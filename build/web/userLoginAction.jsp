...
<div class="status-card">
    ...
    <% if(success){ %>
        ...
        <h3 class="success">Welcome, <%= userName %>!</h3>
        <p><%= message %></p>
        <div class="loader"></div>
        <p>Redirecting to dashboard...</p>
        <a href="userDashboard.jsp" class="btn btn-custom">Go to Dashboard</a>
    ...
    <% } else { %>
        ...
        <p><%= message %></p>
        <a href="userLogin.jsp" class="btn btn-custom">Try Again</a>
    <% } %>
